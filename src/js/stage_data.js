document.addEventListener('DOMContentLoaded', function(){
	var stage_data = {
		dreamland_n64: {
			...
			image: {
				url: "src/images/stages/1x1/dreamland.png",
				alt: "Dreamland",
				title: "Dreamland"
			}
		},
		battlefield: {
			...
			image: {
				url: "src/images/stages/1x1/battlefield.jpg",
				alt: "Battlefield",
				title: "Battlefield"
			}
		},
		final_destination: {
			...
			image: {
				url: "src/images/stages/1x1/Finaldestination.jpg",
		...
		fountain_of_dreams: {
			...
			image: {
				url: "src/images/stages/1x1/Fountainofdreams.jpg",
				alt: "Fountain of Dreams",
		...
		pokemon_stadium: {
			...
			image: {
				url: "src/images/stages/1x1/Pokemonstadium.jpg",
				alt: "Pokémon Stadium",
		...
		yoshis_story: {
			...
			image: {
				url: "src/images/stages/1x1/Yoshi'sStory.png",
				alt: "Yoshi's Story",
				title: "Yoshi's Story"
			}
		},
		big_blue: {
			...
			image: {
				url: "src/images/stages/1x1/Bigblue.jpg",
				alt: "Big Blue",
				title: "Big Blue"
			}
		},
		brinstar: {
			...
			image: {
				url: "src/images/stages/1x1/brinstar.jpg",
				alt: "Brinstar",
				title: "Brinstar"
			}
		},
		brinstar_depths: {
			...
			image: {
				url: "src/images/stages/1x1/Brinstardepths.jpg",
				alt: "Brinstar Depths",
		...
		corneria: {
			...
			image: {
				url: "src/images/stages/1x1/corneria.jpg",
				alt: "Corneria",
				title: "Corneria"
			}
		},
		flat_zone: {
			...
			image: {
				url: "src/images/stages/1x1/Flatzone.jpg",
				alt: "Flatzone",
				title: "Flatzone"
			}
		},
		fourside: {
			...
			image: {
				url: "src/images/stages/1x1/Fourside.png",
				alt: "Fourside",
				title: "Fourside"
			}
		},
		great_bay: {
			...
			image: {
				url: "src/images/stages/1x1/Greatbay.jpg",
				alt: "Great Bay",
				title: "Great Bay"
			}
		},
		green_greens: {
			...
			image: {
				url: "src/images/stages/1x1/Greengreens.jpg",
				alt: "Green Greens",
				title: "Green Greens"
			}
		},
		icicle_mountain: {
			...
			image: {
				url: "src/images/stages/1x1/IcicleMountain.jpg",
				alt: "Icicle Mountain",
		...
		jungle_japes: {
			...
			image: {
				url: "src/images/stages/1x1/JungleJapes.jpg",
				alt: "Jungle Japes",
				title: "Jungle Japes"
			}
		},
		kongo_jungle: {
			...
			image: {
				url: "src/images/stages/1x1/Kongojungle.jpg",
				alt: "Kongo Jungle",
				title: "Kongo Jungle"
			}
		}
